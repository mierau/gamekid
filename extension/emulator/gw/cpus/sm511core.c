...
//  melody controller
//-------------------------------------------------
static inline void sm511_clock_melody(void)
{
	if (!melody_rom)
		return;
...
/********** 1 second timer *********/
static inline void sm511_div_timer_cb(void)
{
...
static void sm511_execute_one(void)
{
	switch (m_op & 0xf0)
	{
...
static inline void sm511_get_opcode_param(void)
{
