...
bool gw_system_config(void);
void gw_system_start(void);
void gw_system_reset(void);
...
// Audio init
void gw_system_sound_init(void);

// ROM loader
bool gw_system_romload(void);
...
unsigned char gw_readBA(void);
unsigned char gw_readB(void);
