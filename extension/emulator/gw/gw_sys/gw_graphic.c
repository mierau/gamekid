...
static inline void update_segment_4bits(uint8 segment_nb, bool segment_state)
{
...
#pragma GCC push_options
#pragma GCC optimize ("unroll-loops")
static inline void update_segment_8bits(uint8 segment_nb, bool segment_state)
{
...
#pragma GCC push_options
#pragma GCC optimize ("unroll-loops")
inline void gw_gfx_sm510_rendering(uint16 *framebuffer)
{
	/*
...
#pragma GCC push_options
#pragma GCC optimize ("unroll-loops")
inline void gw_gfx_sm500_rendering(uint16 *framebuffer)
{
	/*
